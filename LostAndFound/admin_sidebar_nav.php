...
<head>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const submenuPages = {
                'admin_dashboard.php': 'statistics',
...
<body>
    ...
    <div class="admin-sidebar">
        ...
        <div class="admin-nav-menu">
            ...
            <div class="submenu">
                <a href="admin_dashboard.php" class="submenu-item" data-page="statistics">
                ...
                <a href="list_users.php" class="submenu-item" data-page="users">
            ...
            <a href="manage_found_items.php" class="admin-nav-item <?php echo basename($_SERVER['PHP_SELF']) == 'manage_found_items.php' ? 'active' : ''; ?>">
                <div class="admin-nav-icon"><i class="fas fa-box-open"></i></div>
                <div class="admin-nav-text">Manage Found Items</div>
            </a>
            
            <a href="reports.php" class="admin-nav-item <?php echo basename($_SERVER['PHP_SELF']) == 'reports.php' ? 'active' : ''; ?>">
                <div class="admin-nav-icon"><i class="fas fa-chart-pie"></i></div>
                <div class="admin-nav-text">Reports & Analytics</div>
            </a>
            
            <a href="system_settings.php" class="admin-nav-item <?php echo basename($_SERVER['PHP_SELF']) == 'system_settings.php' ? 'active' : ''; ?>">
                <div class="admin-nav-icon"><i class="fas fa-cogs"></i></div>
                <div class="admin-nav-text">System Settings</div>
            </a>
        </div>
    </div>
    ...
    <div class="admin-top-header">
        <div class="admin-page-title">
            ...
            // Dynamic page title
            $page_titles = [
                'admin_dashboard.php' => 'Dashboard Statistics',
                ...
                'list_users.php' => 'User Accounts Management'
            ];
        ...
        <div class="admin-header-right">
            ...
            <div class="admin-dropdown">
                ...
                <div class="admin-dropdown-menu">
                    <a href="admin_profile.php" class="admin-dropdown-item">
                        <i class="fas fa-user-cog admin-dropdown-icon"></i>
                        Admin Profile
                    </a>
                    <a href="admin_settings.php" class="admin-dropdown-item">
                        <i class="fas fa-sliders-h admin-dropdown-icon"></i>
                        Admin Settings
                    </a>
                    <a href="admin_security.php" class="admin-dropdown-item">
                        <i class="fas fa-shield-alt admin-dropdown-icon"></i>
                        Security
                    </a>
                    <div class="admin-dropdown-item">
                        <a href="login.php" class="admin-logout-btn" style="width: 100%; justify-content: center;">
