...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="nav-menu">
            ...
            <a href="my_reports.php" class="nav-item <?php echo basename($_SERVER['PHP_SELF']) == 'my_reports.php' ? 'active' : ''; ?>">
                <div class="nav-icon"><i class="fas fa-file-alt"></i></div>
                <div class="nav-text">My Reports</div>
            </a>
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu">
                    ...
                    <div class="dropdown-item" style="border-top: 1px solid #f8f9fa; margin-top: 5px;">
                        <a href="login.php" class="logout-btn" style="width: 100%; justify-content: center;">
